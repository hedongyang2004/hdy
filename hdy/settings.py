"""
Django settings for hdy project.
...
SECRET_KEY = "django-insecure-^$!7(@-kvp2$ov#k9ohon&j=%kbqxw7%y1a%-^3!&i*02=@fuo"
...
WSGI_APPLICATION = "hdy.wsgi.application"
